...
const About = () => {
  return (
    <div className='w-full md:min-h-[50vh] px-4 lg:px-12 py-36 pb-12'>
       <Header sideText={'About'} mainText={'We build virtual environments'} />

        <div className='m-auto lg:grid grid-cols-5 gap-8'>
            <div className='col-span-3 text-lg pb-4'>
